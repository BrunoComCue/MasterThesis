...
# paths
parser.add_argument('--config_path', type=str, default='configs/config.yaml', help='config file path, depending on whether it is for vehicles or pedestrians')
...
def frame_visualization(bboxes, ids, states, gt_bboxes=None, gt_ids=None, pc=None, dets=None, name=''):
    ...
    # visualizer.show()
    visualizer.save('data/result_waymo/imgs_vc/{:}.png'.format(name))
    visualizer.close()
